...
Code liberally lifted from (GLSL Cookbook Chapter 6)
https://github.com/daw42/glslcookbook/blob/master/chapter06/shader/shadewire.gs
Commented more thoroughly based on the CookBook text
Modified for additional Vertex Attributes - Color, Texture, ShadowCoord
*/
